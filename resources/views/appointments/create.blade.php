...
@section('content')
<div class="container">
    <h1 class="mb-4 text-center">إضافة موعد جديد</h1>
    ...
    <div class="card p-4 mx-auto" style="max-width: 600px;">
        <form action="{{ route('appointments.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select id="doctor_id" name="doctor_id" class="form-select" required> {{-- Bootstrap form-select --}}
            ...
            <div class="mb-3">
                ...
                <textarea id="cancellation_reason" name="cancellation_reason" rows="4" class="form-control">{{ old('cancellation_reason') }}</textarea>
                @error('cancellation_reason') <div class="text-danger">{{ $message }}</div> @enderror
            </div>

            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <button type="submit" class="btn btn-success me-md-2">إضافة موعد</button>
